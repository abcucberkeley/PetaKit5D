...
ip.addParamValue('Sigma', [1.23, 1.1; 1.23, 1.25;1.23, 1.25;]);
...
if ip.Results.RunAnalysis
    ...
    getLifetimeData(data, 'Overwrite', true,...
        ...
        'ExcludeVisitors', true, 'Mask', false, 'AnalysisPath', 'Analysis');
    ...
    lopts = {'Display', 'on', 'ExcludeVisitors', true, 'Overwrite',true};
%     CB =[5 20 40 60 80];
    res.lftRes = runLifetimeAnalysis3D(data,'lb',[1 21 41 61 81 121] ,'ub',[20 40 60 80 120 300], lopts{:});
