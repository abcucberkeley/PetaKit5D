function [inBbox, outBbox, dsr] = XR_getDeskeRotateBoxesFromMasks(maskFullpaths, BorderSize, xyPixelSize, dz, SkewAngle, Reverse, resample, inputBbox)
...
frame = uint16(permute(im_y, [3, 1, 2]));
objectiveScan = false;
