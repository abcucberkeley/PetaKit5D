                ...
                for c = 1:numel(Ch)
                    for z = 1:numel(nz)
                        ...
                        func_str = sprintf(['%s(%s,%s,''axisOrder'',''%s'',''dataOrder'',''%s'',''xyPixelSize'',%0.10f,''dz'',%0.10f,', ...
                            ...
                            '''batchSize'',%s,''blockSize'',%s,''shardSize'',%s,''zarrSubSize'',%s,''resampleType'',''%s'',''resample'',[%s],', ...
                            ...
                            strrep(mat2str(shardSize), ' ', ','), strrep(mat2str(zarrSubSize), ' ', ','), resampleType, ...
                            strrep(num2str(resample, '%.10d,'), ' ', ''),  strrep(mat2str(InputBbox), ' ', ','), ...
                            ...
                            string(bigStitchData), EdgeArtifacts, string(saveMIP), string(parseCluster), uuid, string(mccMode), ConfigFile);
