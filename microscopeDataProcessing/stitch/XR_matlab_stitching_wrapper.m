                ...
                for c = 1:numel(Ch)
                    for z = 1:numel(nz)
                        ...
                        func_str = sprintf(['%s(%s,%s,''axisOrder'',''%s'',''xyPixelSize'',%0.10f,''dz'',%0.10f,', ...
                            ...
                            '''blockSize'',%s,''zarrSubSize'',%s,''resampleType'',''%s'',''resample'',[%s],''InputBbox'',%s,', ...
                            '''tileOutBbox'',%s,''TileOffset'',%d,''BlendMethod'',''%s'',''overlapType'',''%s'',''xcorrShift'',%s,', ...
                            ...
                            strrep(mat2str(poolSize), ' ', ','), strrep(mat2str(blockSize), ' ', ','), strrep(mat2str(zarrSubSize), ' ', ','), ...
