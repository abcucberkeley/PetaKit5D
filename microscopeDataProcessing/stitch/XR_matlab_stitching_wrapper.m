                ...
                for c = 1:numel(Ch)
                    for z = 1:numel(nz)
                        ...
                        func_str = sprintf(['%s(%s,%s,''axisOrder'',''%s'',''xyPixelSize'',%0.10f,''dz'',%0.10f,', ...
                            ...
                            '''ProcessedDirStr'',''%s'',''DS'',%s,''DSR'',%s,''zarrFile'',%s,''blockSize'',%s,''zarrSubSize'',%s,', ...
                            ...
                            '''parseCluster'',%s,''uuid'',''%s'',''mccMode'',%s,''ConfigFile'',''%s'')'], ...
                            ...
                            stitchInfoFullpath, ProcessedDirStr, string(DS), string(DSR), string(zarrFile), strrep(mat2str(blockSize), ' ', ','), ...
