function [fnout] = stitch_generate_imagelist_from_encoder(dataPath, dz)
...
dz_actual = XR_estimate_actual_step_size_from_encoder(dataPath, 'dz', dz, 'onlyFirstRow', true, 'skipMissingFile', true);
