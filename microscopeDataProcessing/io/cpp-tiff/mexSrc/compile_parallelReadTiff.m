...
if isunix && ~ismac
    ...
    if debug
        ...
        mex -outdir ../linux -output parallelReadTiff.mexa64 -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -O3' LDFLAGS='$LDFLAGS -O3' -I'/clusterfs/fiona/matthewmueller/cpp-tiff/c-tiff/jenkinsBuild/install/include' -L'/clusterfs/fiona/matthewmueller/cpp-tiff/c-tiff/jenkinsBuild/install/lib64' -lstdc++ -lcppTiff parallelreadtiffmex.cpp
    end
...
elseif ispc
    ...
    mex  -outdir ../windows -output parallelReadTiff.mexw64 -v CXX="C:/mingw64/bin/g++" -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -O3' LDFLAGS='$LDFLAGS -O3' -I'C:/Users/matt/Documents/GitHub/c-tiff/jenkinsBuild/install/include' -L'C:/Users/matt/Documents/GitHub/c-tiff/jenkinsBuild/install/lib' -lcppTiff.dll parallelreadtiffmex.cpp
end
