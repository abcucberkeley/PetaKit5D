...
if isunix && ~ismac
    ...
    if debug
        ...
        mex -outdir ../linux -output parallelWriteTiff.mexa64 -v CXXOPTIMFLAGS="-DNDEBUG -O3" LDOPTIMFLAGS="-Wl',-rpath='''$ORIGIN'''' -O3 -DNDEBUG" CXXFLAGS='$CXXFLAGS -O3' LDFLAGS='$LDFLAGS -O3' -I'/clusterfs/fiona/matthewmueller/cpp-tiff/c-tiff/jenkinsBuild/install/include' -L'/clusterfs/fiona/matthewmueller/cpp-tiff/c-tiff/jenkinsBuild/install/lib64' -lstdc++ -lcppTiff parallelwritetiffmex.cpp
    end
