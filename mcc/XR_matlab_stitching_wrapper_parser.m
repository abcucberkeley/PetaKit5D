...
XR_matlab_stitching_wrapper(dataPath, imageListFileName, Streaming=Streaming,...
    ...
    ObjectiveScan=ObjectiveScan, IOScan=IOScan, zarrFile=zarrFile, blockSize=blockSize, ...
    zarrSubSize=zarrSubSize, resampleType=resampleType, resample=resample, ...
    InputBbox=InputBbox, tileOutBbox=tileOutBbox, TileOffset=TileOffset, Resolution=Resolution, ...
    resultDir=resultDir, BlendMethod=BlendMethod, overlapType=overlapType, ...
