...
XR_deskewRotateFrame(framePath, xyPixelSize, dz, DSDirName=DSDirName, DSRDirName=DSRDirName, ...
    ...
    crop=crop, skewAngle=skewAngle, reverse=reverse, inputAxisOrder=inputAxisOrder, ...
    outputAxisOrder=outputAxisOrder, rotate=rotate, inputBbox=inputBbox, flipZstack=flipZstack, ...
    sCMOSCameraFlip=sCMOSCameraFlip, FFCorrection=FFCorrection, lowerLimit=lowerLimit, ...
    FFImage=FFImage, backgroundImage=backgroundImage, constOffset=constOffset, ...
