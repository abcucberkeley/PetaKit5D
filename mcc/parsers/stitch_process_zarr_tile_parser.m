...
stitch_process_zarr_tile(inputFilename, zarrFilename, frame, Overwrite=Overwrite, ...
    blockSize=blockSize, shardSize=shardSize, expand2dDim=expand2dDim, flipZstack=flipZstack, ...
    resample=resample, inputBbox=inputBbox, tileOutBbox=tileOutBbox, compressor=compressor, ...
