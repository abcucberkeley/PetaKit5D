...
XR_matlab_stitching_wrapper(dataPath, imageListFileName, Streaming=Streaming, ...
    ...
    shardSize=shardSize, resampleType=resampleType, resample=resample, InputBbox=InputBbox, ...
    tileOutBbox=tileOutBbox, TileOffset=TileOffset, Resolution=Resolution, ...
