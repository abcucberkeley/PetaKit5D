...
XR_decon_data_wrapper(dataPaths,'deconPathstr',deconPathstr,'Overwrite',Overwrite,...
    ...
    'psfFullpaths',psfFullpaths,'rotatePSF',rotatePSF,'DeconIter',DeconIter, ...
    ...
    'zarrFile',zarrFile,'saveZarr',saveZarr,'scaleFactor',scaleFactor,'deconMaskFns',deconMaskFns, ...
