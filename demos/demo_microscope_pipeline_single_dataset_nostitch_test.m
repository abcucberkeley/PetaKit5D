...
LSImagePaths = {'/clusterfs/fiona/Data/20200803_LLCPKI/20200803_Calibration/FF/AVG_560nm.tif',...
'/clusterfs/fiona/Data/20200803_LLCPKI/20200803_Calibration/FF/AVG_488nm.tif'};

% camera background image paths in the order of CamB and CamA
BackgroundPaths = {'/clusterfs/fiona/OrcaDC/Aang/Orca_Aang_AVG_Cam_A.tif',...
    '/clusterfs/fiona/OrcaDC/Aang/Orca_Aang_AVG_Cam_B.tif'};
...
PSFFullpaths = {'/clusterfs/fiona/Data/20200806_p35p4_Hex_Raptv_234-1_DLS/20200806_Calibration/PSF/Hex/TotPSF_560_CamA_5.tif', ...
'/clusterfs/fiona/Data/20200806_p35p4_Hex_Raptv_234-1_DLS/20200806_Calibration/PSF/Hex/TotPSF_488_CamB_3.tif'};
...
XR_microscopeAutomaticProcessing(dataPath, 'xyPixelSize', xyPixelSize, 'dz', dz,  ...
    ...
    'RotateAfterDecon', RotateAfterDecon, 'PSFFullpaths', PSFFullpaths,'DS', DS, ...
    'DSR', DSR, 'Background', Background, 'cpusPerTask', cpusPerTask);
