...
simReconAutomaticProcessing(dataF,'dz',.26,'PSFs',{[rt_psf fn], [rt_psf fn2]},'lattice_period', lattice_period,...
                        ...
                        'perdecomp', true, 'useGPU', useGPU, 'DS', ds,'Background', Background488,'ChannelPatterns',{'CamA_ch0_CAM1_stack000','CamB_ch0_CAM1_stack000'},'Streaming',true);