...
simReconAutomaticProcessing(dataF,'dz',.26,'PSFs',{[rt_psf fn]},'lattice_period', lattice_period,...
                        ...
                        'Deskew', false, 'parPoolSize', 16, 'EdgeErosion', 14, 'SaveMaskfile', false, 'resultsDirName', 'sim_recon_bk18_cs32_ol128_taperFalse_occThreshp2_w25e-3_apodizeFalse', ...
                        'w', 25e-3, 'apodize', false, 'occThresh', .2);